...
export class RestService {
 ...
 // public update(id, companyData): Observable<CompanyData> {
 //    return this.httpClient.put<CompanyData>(this.BASE_URL + '/home/' + id, JSON.stringify(companyData), this.httpOptnions)
 //      .pipe(
